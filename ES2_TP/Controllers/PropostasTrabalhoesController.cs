...
namespace ES2_TP.Controllers
{
    public class PropostasTrabalhoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCategoria,IdSkill,AnosExperiencia,TotalHoras,Nome,Descricao")] PropostasTrabalho propostasTrabalho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,IdCategoria,IdSkill,AnosExperiencia,TotalHoras,Nome,Descricao")] PropostasTrabalho propostasTrabalho)
        {
